...
<div class="container-fluid">
    ...
    <div class="col-sm-10 offset-sm-2">
        <form class="form-horizontal" role="form" method="POST" action="{{route('empleados.update',$empleado->id)}}">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="card col-sm-8 offset-sm-2">
                <div class="card-header text-white bg-primary">Editar Empleado</div>
                <div class="card-body">
                    <div class="row">
